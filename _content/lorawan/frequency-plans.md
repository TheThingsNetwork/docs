...
Note that The Things Network uses 2nd Sub-Band only (channels 8,9,10,11,12,13,14,15,65). You'll need to program the specific channels into the devices in order to make them work with TTN.
