...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  ...
	  if ($('.layout-guide').length) {
	    ...
	    var Clipboard = __webpack_require__(100);
	    ...
	    var smoothScroll = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (e, t) {
	  ...
	  var t,
	      ...
	      s = { selector: "[data-scroll]", selectorHeader: null, speed: 500, easing: "easeInOutCubic", offset: 0, callback: function callback() {} },
	      f = function f() {
	    var e = {},
	        t = !1,
	        n = 0,
	    ...
	    "#" === e.charAt(0) && (e = e.substr(1));for (var t, n = String(e), o = n.length, r = -1, a = "", i = n.charCodeAt(0); ++r < o;) {
	      if (t = n.charCodeAt(r), 0 === t) throw new InvalidCharacterError("Invalid character: the input contains U+0000.");a += t >= 1 && t <= 31 || 127 == t || 0 === r && t >= 48 && t <= 57 || 1 === r && t >= 48 && t <= 57 && 45 === i ? "\\" + t.toString(16) + " " : t >= 128 || 45 === t || 95 === t || t >= 48 && t <= 57 || t >= 65 && t <= 90 || t >= 97 && t <= 122 ? n.charAt(r) : "\\" + n.charAt(r);
	    }return "#" + a;
	  },
	      g = function g(e, t) {
	    ...
	    } while (e);return o = Math.max(o - t - n, 0), Math.min(o, v() - b());
	  },
	      b = function b() {
	    ...
	    var u = y(o ? o.getAttribute("data-options") : null),
	      ...
	      var m = e.pageYOffset;l.selectorHeader && !r && (r = document.querySelector(l.selectorHeader)), a || (a = O(r));var b,
	          I,
	          ...
	          j = 0,
	          L = function L(t, r, a) {
	        var i = e.pageYOffset;(t == r || i == r || e.innerHeight + i >= A) && (clearInterval(a), H(n, r, d), l.callback(n, o));
	      },
	          w = function w() {
	    ...
	    e.location.hash;n && (n.id = n.getAttribute("data-scroll-id"), u.animateScroll(n, o), n = null, o = null);
	  },
	      S = function S(r) {
	    if (0 === r.button && !r.metaKey && !r.ctrlKey && (o = h(r.target, t.selector), o && "a" === o.tagName.toLowerCase() && o.hostname === e.location.hostname && o.pathname === e.location.pathname && /#/.test(o.href))) {
	      var a = m(o.hash);if ("#" === a) {
	        r.preventDefault(), n = document.body;var i = n.id ? n.id : "smooth-scroll-top";return n.setAttribute("data-scroll-id", i), n.id = "", void (e.location.hash.substring(1) === i ? I() : e.location.hash = i);
...
/***/ function(module, exports, __webpack_require__) {
	...
	try {
	  var query = __webpack_require__(109);
	} catch (err) {
	  var query = __webpack_require__(109);
	}
